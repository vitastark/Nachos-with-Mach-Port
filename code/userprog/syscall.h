...
#define SC_ForkPOS      16
#define SC_WaitPOS      17

#define SC_Add		42
#define SC_Register     18
#define SC_Send         19
...
int Fork_POS(ThreadId id);

void Wait_POS(ThreadId id);

void Register(int portNumber);

void Send(char* msg, int size, int portNumber);

void Receive(int portNumber);
